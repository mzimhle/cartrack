...
if(isset($_GET['action']) && trim($_GET['action']) == 'search') {
	...
	if($requestData['code'] == 200) {
		for($i = 0; $i < count($requestData['record']); $i++) {
			...
			$request[$i] = array(
				'<a href="/animal/details.php?id='.trim($item['id']).'">'.trim($item['name']).'</a>',
...
<html lang="en">
  ...
  <body>
    ...
    <div class="slim-mainpanel">
      <div class="container">
        ...
        <div class="section-wrapper">
		  <label class="section-title">Animal List</label>
            <p class="mg-b-20 mg-sm-b-20">Below is a list of Animal you have added.</p>
            <div class="row">
                <div class="col-md-12">					
				<div class="row">						
					<div class="col-sm-12">				
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-secondary fr" type="button" onclick="link('/animal/details.php'); return false;">Add Animal</button>
                    </div>
    ...
    function getRecords() {
        ...
        $('#tableContent').html('');
        $('#tableContent').html('<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Name</th><th></th></tr></thead><tbody id="contentbody"><tr><td colspan="2" align="center"></td></tr></tbody></table>');	
            ...
            "fnServerData": function ( sSource, aoData, fnCallback ) {
                $.getJSON( sSource, aoData, function (json) {
                    if (json.result === false) {
                        $('#productbody').html('<tr><td colspan="2" align="center">No results</td></tr>');
                    } else {
